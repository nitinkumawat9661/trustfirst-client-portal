...
import { Building2, CreditCard, FileText, LayoutDashboard, PackageSearch, ShieldCheck, UsersRound } from "lucide-react";
...
const nav = {
  ...
  client: [
    ...
    { href: "/client/hardware/overview", label: "Hardware", icon: PackageSearch },
